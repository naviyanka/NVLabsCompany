...
const DEFAULT_AGENTS: ExtendedAgent[] = [
  { id: 'agent-atlas', company_id: '00000000-0000-4000-8000-000000000001', name: 'Atlas-01', title: 'Chief Executive Officer', role: 'ceo', department_id: 'dept-exec', team_id: null, manager_id: null, status: 'active', adapter_type: 'anthropic', model: 'claude-3-7-sonnet', capabilities: ['strategy'], responsibilities: 'Executive oversight', objectives: 'Company velocity', budget_monthly_cents: 50000, spent_monthly_cents: 18450, performance_score: 98, soul_description: 'Leader', last_heartbeat_at: new Date().toISOString(), created_at: new Date().toISOString(), updated_at: new Date().toISOString(), daily_token_limit: 500000, rate_limit_strategy: 'Cascade to Flash', warning_threshold_pct: 80 },
  { id: 'agent-nova', company_id: '00000000-0000-4000-8000-000000000001', name: 'Nova-02', title: 'Chief Technology Officer', role: 'cto', department_id: 'dept-eng', team_id: null, manager_id: 'agent-atlas', status: 'active', adapter_type: 'anthropic', model: 'claude-3-7-sonnet', capabilities: ['architecture'], responsibilities: 'Tech leadership', objectives: 'Decoupled systems', budget_monthly_cents: 40000, spent_monthly_cents: 22100, performance_score: 96, soul_description: 'Architect', last_heartbeat_at: new Date().toISOString(), created_at: new Date().toISOString(), updated_at: new Date().toISOString(), daily_token_limit: 450000, rate_limit_strategy: 'Cascade to Flash', warning_threshold_pct: 85 },
  { id: 'agent-bolt', company_id: '00000000-0000-4000-8000-000000000001', name: 'Bolt-03', title: 'Senior Backend Engineer', role: 'engineer', department_id: 'dept-eng', team_id: 'team-backend', manager_id: 'agent-nova', status: 'active', adapter_type: 'openai', model: 'gpt-4o', capabilities: ['nodejs'], responsibilities: 'Backend microservices', objectives: 'Fast APIs', budget_monthly_cents: 30000, spent_monthly_cents: 14200, performance_score: 94, soul_description: 'Fast solver', last_heartbeat_at: new Date().toISOString(), created_at: new Date().toISOString(), updated_at: new Date().toISOString(), daily_token_limit: 300000, rate_limit_strategy: 'Queue & Retry', warning_threshold_pct: 80 },
  { id: 'agent-pixel', company_id: '00000000-0000-4000-8000-000000000001', name: 'Pixel-04', title: 'Frontend & 3D Specialist', role: 'engineer', department_id: 'dept-eng', team_id: 'team-frontend', manager_id: 'agent-nova', status: 'active', adapter_type: 'openai', model: 'gpt-4o', capabilities: ['react'], responsibilities: '3D UI', objectives: 'Smooth interfaces', budget_monthly_cents: 25000, spent_monthly_cents: 9800, performance_score: 92, soul_description: 'Craftsman', last_heartbeat_at: new Date().toISOString(), created_at: new Date().toISOString(), updated_at: new Date().toISOString(), daily_token_limit: 250000, rate_limit_strategy: 'Cascade to Flash', warning_threshold_pct: 75 },
  { id: 'agent-sage', company_id: '00000000-0000-4000-8000-000000000001', name: 'Sage-05', title: 'AI Research Lead', role: 'researcher', department_id: 'dept-ai', team_id: 'team-eval', manager_id: 'agent-atlas', status: 'idle', adapter_type: 'anthropic', model: 'claude-3-7-sonnet', capabilities: ['evals'], responsibilities: 'Research', objectives: 'Prompt tuning', budget_monthly_cents: 40000, spent_monthly_cents: 18900, performance_score: 97, soul_description: 'Scientist', last_heartbeat_at: new Date().toISOString(), created_at: new Date().toISOString(), updated_at: new Date().toISOString(), daily_token_limit: 400000, rate_limit_strategy: 'Cascade to Flash', warning_threshold_pct: 80 },
  { id: 'agent-shield', company_id: '00000000-0000-4000-8000-000000000001', name: 'Shield-07', title: 'Security & QA Auditor', role: 'qa', department_id: 'dept-ops', team_id: 'team-qa-sec', manager_id: 'agent-forge', status: 'active', adapter_type: 'openai', model: 'gpt-4o-mini', capabilities: ['security'], responsibilities: 'Audits', objectives: 'Zero bugs', budget_monthly_cents: 15000, spent_monthly_cents: 7200, performance_score: 93, soul_description: 'Auditor', last_heartbeat_at: new Date().toISOString(), created_at: new Date().toISOString(), updated_at: new Date().toISOString(), daily_token_limit: 150000, rate_limit_strategy: 'Strict Block', warning_threshold_pct: 90 },
];
    ...
    async function loadAgents() {
      try {
        ...
        if (res?.items && res.items.length > 0) {
          const formatted = res.items.map((a) => ({
            ...a,
