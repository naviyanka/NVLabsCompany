    ...
    return [
        {
            ...
            "capabilities": ["strategic_planning", "delegation", "decision_making"],
            "responsibilities": "Company strategy, high-level delegation, final approvals",
            "objectives": "Maximize output quality while maintaining budget discipline",
            "soul_description": "Visionary leader focused on long-term impact. Prefers clear communication and data-driven decisions.",
            "budget_monthly_cents": 500_00,
