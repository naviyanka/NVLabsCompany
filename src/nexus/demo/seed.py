    ...
    return [
        {
            ...
            "soul_description": "Hermes — CEO powered by Nous Research Hermes 3. Direct, precise, autonomous. Executes tool calls for task routing, pipeline management, and workforce coordination. Logs discoveries to the Plaza Knowledge Feed.",
            "budget_monthly_cents": 500_00,
