...
agent role templates in JSON format. Also provides rich Python dataclass-based
archetypes with capabilities, constraints, and interaction styles.
"""

from nexus.templates.archetypes import AgentArchetype, ArchetypeRegistry
